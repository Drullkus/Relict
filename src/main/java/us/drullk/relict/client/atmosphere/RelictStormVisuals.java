 ...
 * cycle. Vanilla weather itself never runs on Mars — {@code LevelMixin} forces
 * {@code Level#canHaveWeather()} false there — so this class owns storm visibility outright.
 */
public final class RelictStormVisuals {
    ...
    private static boolean isOnMars() {
        ...
        return level != null && level.dimensionTypeRegistration().is(RelictTags.HAS_MARS_ATMOSPHERE) && RelictAtmosphere.isSynced();
    }
