...
public class RelictStructures {
    ...
    public static final ResourceKey<StructureSet> OVERCAST_MOORING_SET = ResourceKey.create(Registries.STRUCTURE_SET, Relict.id("overcast_mooring"));
    ...
    public static final ResourceKey<Structure> OVERCAST_MOORING = ResourceKey.create(Registries.STRUCTURE, Relict.id("overcast_mooring"));
