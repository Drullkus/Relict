...
/**
 * The noise channels that shape mesa's surface primitive, and the graph nodes that wire them up.
 *
 ...
 */
public final class RelictMesaField {
    ...
    private static Map<ResourceKey<NormalNoise.NoiseParameters>, NormalNoise.NoiseParameters> noiseParameters() {
        ...
        parameters.put(RelictNoises.MESA_WARP_X, octaves(1));
        parameters.put(RelictNoises.MESA_WARP_Z, octaves(1));
        parameters.put(RelictNoises.MESA_SERRATION_X, octaves(1));
        parameters.put(RelictNoises.MESA_SERRATION_Z, octaves(1));
        parameters.put(RelictNoises.MESA_UNDULATION, octaves(1));
